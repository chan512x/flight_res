...
try:
    ...
    while current_date <= end_date:
        ...
        src="BLR"
        dest="DEL"
        with open(f'magicfares_scrape/{src}-{dest}/{date_str}.json','r') as jsonf:
            ...
            for row in data:
                ...
                if stop=="N":
                    ...
                    if temp:
                        cur.execute('''UPDATE FSCHEDULE SET mf_price=%s WHERE flight_id=%s AND whe=%s AND dept=%s''',(price, id, date_str, dept))
                    else:
